...
if("TRUE" STREQUAL "TRUE")
  set(detect_SOURCE_PREFIX /home/orange/orange_ws/src/detect)
  set(detect_DEVEL_PREFIX /home/orange/orange_ws/devel)
  set(detect_INSTALL_PREFIX "")
  set(detect_PREFIX ${detect_DEVEL_PREFIX})
else()
  set(detect_SOURCE_PREFIX "")
  set(detect_DEVEL_PREFIX "")
  set(detect_INSTALL_PREFIX /home/orange/orange_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'orange <orange@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'detect' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/orange/orange_ws/src/detect/${idir}'.  ${_report}")
    endif()
